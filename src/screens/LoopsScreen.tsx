...
const makeStyles = (t: ThemeTokens) => StyleSheet.create({
    ...
    headerTitle: { color: t.text.primary, fontSize: 16, fontWeight: '900', letterSpacing: 2 },
    headerSub: { color: t.accent.indigo, fontSize: 11, fontWeight: '800', marginTop: 2 },
    center: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 32 },
    emptyTitle: { color: t.text.primary, fontSize: 18, fontWeight: '800', marginTop: 16 },
    emptyText: { color: t.text.muted, fontSize: 14, textAlign: 'center', marginTop: 8, lineHeight: 20 },
    ...
    laneHint: { color: t.text.disabled, fontSize: 12, marginTop: 4, lineHeight: 16 },
    laneEmpty: { color: t.text.disabled, fontSize: 13, fontStyle: 'italic', paddingVertical: 8, lineHeight: 18 },
    ...
    returnCard: {
        ...
        borderWidth: 1,
        borderLeftWidth: 3,
        borderColor: t.accent.redSoft,
        borderLeftColor: t.accent.red,
    },
    returnTopRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 },
    themeChip: { backgroundColor: t.accent.redSoft, paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    themeChipText: { color: t.accent.red, fontSize: 11, fontWeight: '800', letterSpacing: 0.3 },
    recurrenceText: { color: t.accent.red, fontSize: 11, fontWeight: '800' },
    avoidanceText: { color: t.text.primary, fontSize: 16, fontWeight: '600', lineHeight: 23 },
    returnDivider: { height: 1, backgroundColor: t.border.subtle, marginVertical: 14 },
    nextLabel: { color: t.text.muted, fontSize: 10, fontWeight: '900', letterSpacing: 1.5, marginBottom: 4 },
    nextTask: { color: t.text.secondary, fontSize: 14, lineHeight: 20 },
    closeBtn: {
        flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
        marginTop: 16, paddingVertical: 11, borderRadius: 12,
        backgroundColor: t.accent.greenSoft, borderWidth: 1, borderColor: t.accent.green,
    },
    closeBtnText: { color: t.accent.green, fontSize: 14, fontWeight: '800', marginLeft: 8 },
    ...
    checkbox: {
        width: 26, height: 26, borderRadius: 13, borderWidth: 2, borderColor: t.border.strong,
        alignItems: 'center', justifyContent: 'center', marginRight: 14,
    },
    simpleTask: { color: t.text.primary, fontSize: 15, fontWeight: '600', marginBottom: 6, lineHeight: 20 },
    simpleBadges: { flexDirection: 'row', flexWrap: 'wrap', gap: 6 },
    categoryBadge: { backgroundColor: t.border.subtle, paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
    categoryText: { color: t.text.muted, fontSize: 10, fontWeight: 'bold', textTransform: 'uppercase' },
    priorityBadge: { backgroundColor: t.accent.redSoft, paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
    priorityText: { color: t.accent.red, fontSize: 10, fontWeight: 'bold', textTransform: 'uppercase' },
    moveBtn: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, paddingVertical: 8, marginLeft: 8 },
    moveBtnText: { color: t.text.muted, fontSize: 12, fontWeight: '700', marginRight: 4 },
});
