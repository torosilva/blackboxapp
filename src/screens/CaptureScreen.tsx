...
const makeStyles = (tokens: ThemeTokens) => StyleSheet.create({
    ...
    brand: { color: tokens.text.disabled, fontSize: 12, fontWeight: '900', letterSpacing: 0 },
    headerBtn: {
    ...
    statusMain: { color: tokens.text.primary, fontSize: 28, fontWeight: '800', letterSpacing: 0.2 },
    statusSub: { color: tokens.text.muted, fontSize: 15, fontWeight: '600', marginTop: 6, lineHeight: 21 },
    statsGrid: {
        flexDirection: 'row',
        gap: 8,
        marginTop: 8,
    ...
    statValuePos: { color: tokens.accent.green },
    statValueNeutral: { color: tokens.text.primary },
    statValueWarn: { color: tokens.accent.amber },
    statLabel: {
        fontSize: 10,
        fontWeight: '700',
        color: tokens.text.muted,
    ...
    reflejoDate: { color: tokens.text.muted, fontSize: 11, fontWeight: '700' },
    reflejoText: { color: tokens.text.primary, fontSize: 15, lineHeight: 22, fontWeight: '500' },
    reflejoMore: { color: tokens.accent.purple, fontSize: 13, fontWeight: '800', marginTop: 10 },
    ...
    retryBannerText: { color: tokens.accent.amber, fontSize: 13, fontWeight: '700' },
    ...
    loopsTitle: { color: tokens.text.primary, fontSize: 16, fontWeight: '900', letterSpacing: 1.5 },
    loopsTitleRegresa: {
    ...
    textCaptureCard: {
        ...
        alignItems: 'center',
        gap: 12,
        backgroundColor: tokens.bg.inputInverted,
        borderWidth: 0,
        borderRadius: 14,
        paddingVertical: 18,
    ...
    textCaptureInput: {
        flex: 1,
        color: tokens.text.onInverted,
        fontSize: 16,
        fontWeight: '500',
        paddingVertical: 0,
        textAlignVertical: 'center',
    },
    loopsCounter: { color: tokens.accent.green, fontSize: 12, fontWeight: '400', marginTop: -6, marginBottom: 12 },
    sectionLink: { color: tokens.accent.indigo, fontSize: 13, fontWeight: '800' },
    ...
    loopCardRegresa: {
        ...
        borderColor: tokens.accent.purple,
        borderLeftWidth: 3,
        borderLeftColor: tokens.accent.purple,
    },
    loopText: { color: tokens.text.primary, fontSize: 16, fontWeight: '600', lineHeight: 22 },
    ...
    emptyLoopsText: { color: tokens.text.muted, fontSize: 15, lineHeight: 22 },
    ...
    memHeader: { color: tokens.text.muted, fontSize: 13, fontWeight: '700', letterSpacing: 0.3 },
    memCard: {
        flexDirection: 'row',
        alignItems: 'center',
        backgroundColor: tokens.bg.card,
    ...
    recDot: { width: 9, height: 9, borderRadius: 5, backgroundColor: tokens.accent.red, marginRight: 9 },
    recPillText: { color: tokens.text.primary, fontSize: 13, fontWeight: '700' },

    // Text sheet (modal)
    modalRoot: { flex: 1, justifyContent: 'flex-end' },
    modalBackdrop: { ...StyleSheet.absoluteFillObject, backgroundColor: tokens.bg.overlay },
    modalSheet: {
    ...
    iconBtnRecording: { backgroundColor: tokens.accent.redSoft, borderColor: tokens.accent.red },
    wordCount: { color: tokens.text.disabled, fontSize: 12 },
    recordingBar: {
    ...
    recordingDot: { width: 10, height: 10, borderRadius: 5, backgroundColor: tokens.accent.red, marginRight: 10 },
    recordingText: { color: tokens.accent.red, fontSize: 13, fontWeight: '700', flex: 1 },
    imagePreview: {
        flexDirection: 'row', alignItems: 'center',
    ...
    imageHint: { color: tokens.text.link, fontSize: 12, fontWeight: '600', flex: 1 },
    imageRemove: { padding: 6 },
    sendBtn: { width: 40, height: 40, borderRadius: 20, justifyContent: 'center', alignItems: 'center' },
    sendBtnActive: { backgroundColor: tokens.accent.indigo },
    sendBtnDisabled: { backgroundColor: tokens.bg.scrim, borderWidth: 1, borderColor: tokens.border.subtle },
});
